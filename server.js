...
async function setupDatabase() {
    ...
    IMPORTANT:
    The old database already had an "amount" column
    that was NOT NULL.

    We keep that column and now ALWAYS save it.
    ==================================================
    */
...
async function creditVerifiedPayment(
    ...
    try {
        ...
        /*
        Use the amount stored in the database.
        Never trust the browser amount here.
        */
    ...
    async (req, res) => {
        ...
        try {
            ...
            */
            ...
            IMPORTANT:
            The old PostgreSQL table has a required
            "amount" column.

            We now save ALL THREE:
            amount
            amount_kobo
            amount_naira
            ==================================================
            ...
            */
            ...
            Convert to:
            https://api.moneta.ng/api/v2/txn/isw/REFERENCE
            */
        ...
        try {
            ...
            return res.send(`
                ...
                ">
                    ...
                    <p>
                        Please return to Zavero
                        and check your balance shortly.
                    </p>
...
app.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            /*
            We do not trust the webhook amount.
            We verify the reference directly
            with Moneta before crediting.
            */
